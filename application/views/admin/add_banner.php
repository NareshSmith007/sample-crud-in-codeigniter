...
<div class='col-md-4'><h4>Add Banners</h4></div>
...
<input class="form-control" placeholder="Age"  id="age" name="age" type="text" value="">
</div>
</div>
</div>
...
<script type="text/javascript">
   $("#xin-form").submit(function(){
    ...
    alert(age);
    $.ajax({  
url:'<?php echo base_url() ?>'+"admin/index/to_add",  
method:"POST",  
